(* C2PP
  ...
  ***************************************************************************
  File last update : 2026-01-11T00:43:10.000+01:00
  Signature : 34961a518b68756468b1ed9b5c509cad74d01f8f
  ***************************************************************************
*)
...
begin
  ...
  try
    ...
    try
      ...
      ExpirationTime := IncMinute( Now, 1440 ); // Temps d'expiration en minutes
